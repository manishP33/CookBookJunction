...
Cook's Tips
Packets may be baked on shallow pan in 425°F oven 25 to 30 minutes or until chicken is cooked through (180°F) and rice is tender.", recipe_blogger_id: 1)
...
Serve dip in bread bowl or with tortilla chips, if desired.", recipe_blogger_id: 2)
...
Cook's Tips
To make less spicy, reduce Sriracha sauce to 3 tablespoons.", recipe_blogger_id: 3)
...
Bake 30 minutes or until golden brown. Cool 5 minutes; cut into 12 slices.", recipe_blogger_id: 4)
...
Top chicken with remaining cheeses; bake, uncovered, 5 minutes or until mozzarella is melted. Drain spaghetti. Serve topped with chicken and sauce.", recipe_blogger_id: 2)
...
Remove chicken from skillet; shred with two forks. Return chicken to sauce mixture; stir to combine. Sprinkle each serving with cheese and avocado. Serve with rice, if desired.", recipe_blogger_id: 1)
